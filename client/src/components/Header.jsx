...
const Header = () => {
  return (
    <div className="px-3 flex items-center justify-between w-full z-100 h-15 md:max-w-[960px] md:h-20 lg:max-w-[1520px] lg:h-20">
      ...
      <div className="hidden md:inline-flex search relative z-100">
        <input
          className="flex items bg-gray-100 px-6 outline-0 rounded-[2em] transition-shadow duration-200 ease-in hover:shadow-xl md:w-[25em] md:py-1.5 md:placeholder:text-[1em] lg:w-[36em] lg:py-2.5"
          type="text"
          name=""
          id=""
          placeholder="Search"
        />
        <MdRefresh className="absolute right-2 top-1 md:size-5 md:top-2 lg:size-8 lg:top-2 text-gray-500 cursor-pointer transition-all hover:text-gray-800" />
      </div>
      ...
      <div className="flex justify-between w-60 items-center">
        ...
        <CgProfile className="hidden md:inline-flex md:size-5 lg:size-7 cursor-pointer" />
